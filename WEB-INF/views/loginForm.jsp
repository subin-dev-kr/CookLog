							...
							<form class="text-start" action="login" method="post">
								...
								<div class="mb-3">
									...
									<input class="form-control form-control-lg rounded-1 w-100"
										type="text" id="mId" name="mId" placeholder="아이디를 입력해주세요" required />
								</div>

								<div class="mb-4">
									<label class="form-label fw-bold" for="mPw">비밀번호</label> 
									<input class="form-control form-control-lg rounded-1 w-100" type="password" 
										id="mPw" name="mPw" placeholder="비밀번호를 입력해주세요" required />
								</div>
								...
								<div class="d-grid mt-4">
									<a class="btn btn-success btn-lg rounded-1" href="<c:url value='/member/joinForm'/>">회원가입</a>
								</div>
							</form>
						</div>
					</div>
