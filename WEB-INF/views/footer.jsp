...
<footer class="cooklog-footer py-5">
	<div class="container">
		<div>
			...
			<span class="text-1000 fs-5 fw-bold ms-2 text-gradient"> 
				<a class="navbar-brand d-inline-flex" href="<c:url value='/'/>">CookLog</a>
			</span>
		</div>
		...
		<div class="row flex-center pb-3">
			<div class="col-md-6 order-0">
				<p class="text-200 text-center text-md-start">All rights Reserved &copy; Your Company, 2025</p>
			</div>
			<div class="col-md-6 order-1">
				<p class="text-200 text-center text-md-end">Made with&nbsp; 
					<i class="fa-solid fa-heart link-primary me-1"></i>&nbsp;by&nbsp;
					<a class="text-200 fw-bold" href="http://localhost:8080/CookLog/" target="_blank">CookLog</a>
				</p>
			</div>
		</div>
	</div>
