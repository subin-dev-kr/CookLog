...
<body>
	...
	<header class="container">
		<h1 class="fs-5 fw-bold ms-2 my-4 d-flex align-items-center text-danger">
			My 레시피<i class="material-symbols-outlined fs-5">chef_hat</i>
		</h1>
		<div class="mb-5 p-3 d-flex justify-content-between align-items-center shadow-sm">
	...
	<main class="container py-5">
		...
		<section class="mb-5">
			...
			<c:forEach var="step" items="${recipe.cookingSteps}" varStatus="status">
		...
		<div class="container d-flex align-items-center">
			<a href="<c:url value='/member/myPage'/>" class="btn btn-success py-2 px-3 text-nowrap me-2">
				마이페이지
			</a>
			<div class="d-flex align-items-center ms-auto">
				<a href="<c:url value='/recipe/updateForm?rNum=${recipe.rNum}'/>" class="btn btn-primary py-2 px-3 text-nowrap me-2">
					수정하기
				</a>
