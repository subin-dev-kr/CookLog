...
public class RecipeServiceImpl implements RecipeService {
	...
	// 레시피 좋아요순 페이징
	@Override
	public List<Recipe> getRecipePageByLike(int offset, int pageSize) {
		
		return recipeRepository.findPageOrderByLike(offset, pageSize);
	}
	//레시피 수정
	@Override
	...
	//좋아요 상태 조회
	@Override
	public boolean isLikedByUser(int rNum, String mId) {
		
		return recipeRepository.exists(rNum, mId);
	}
