...
public interface MemberRepository {
	...
	boolean isNickNameExcptMe(String mNickName, String mId); //내꺼 제외한 닉네임 중복체크
	boolean isEmailExceptMe(String email, String mId);       //내꺼 제외한 이메일 중복체크 
