...
public class MemberRepositoryImpl implements MemberRepository {
	...
	public void update(Member member) {
		...
		String SQL = "UPDATE member SET m_pw = IFNULL(NULLIF(?, ''), m_pw), m_nick_name = ?, email = ?, phone = ? WHERE m_id = ?";
	...
	public boolean isNickNameExcptMe(String mNickName, String mId) {
		String SQL = "SELECT COUNT(*) FROM member WHERE m_nick_name = ? AND m_id <> ?";
		Integer count = template.queryForObject(SQL, Integer.class, mNickName, mId);
	...
	String SQL = "SELECT COUNT(*) FROM member WHERE email = ? AND m_id <> ?";
		Integer count = template.queryForObject(SQL, Integer.class, email, mId);
